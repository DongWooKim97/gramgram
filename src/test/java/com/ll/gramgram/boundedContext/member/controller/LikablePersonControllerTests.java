...
import com.ll.gramgram.boundedContext.likablePersone.controller.LikablePersonController;
...
public class LikablePersonControllerTests {
    @Autowired
    private MockMvc mvc;
    ...
    void t001() throws Exception {
        ...
        ResultActions resultActions = mvc
                .perform(get("/likablePerson/add"))
                .andDo(print());

        // THEN
        resultActions
                .andExpect(handler().handlerType(LikablePersonController.class))
